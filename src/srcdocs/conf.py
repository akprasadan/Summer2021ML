...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.viewcode', 'sphinx_last_updated_by_git', 'myst_parser']
...
html_theme_options = {'collapse_navigation': False, 'navigation_depth': 4,  'prev_next_buttons_location' : 'both'}